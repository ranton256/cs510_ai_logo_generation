...
content_input_path = "font_contents/"
content_with_ext   = "test.png"
content_image_path = content_input_path + content_with_ext
content_image      = content_with_ext[:-4]

# Style image to use.
style_input_path   = "styles/"
style_with_ext     = "test_style.jpg"
...
parser.add_argument("--IMAGE_WIDTH", "-width",type=int, default = 300, help = "width & height of image")
...
# EDIT: removed 1 from 1 - slash to return proper file name
...
if __name__ == '__main__':
    ...
    with device: 
        with tf.Session() as sess:          
            ...
            # Load images.
            content_source = f'{CONTENT_IMAGE}'
